/*!
 * Live2D APi
 * https://github.com/dingeral/live2d-api
 */
!function() {
    "use strict";
    function e(e) {
    ...
    let t;
    function o(o, s, i) {
        if (!o || sessionStorage.getItem("waifu-text") && sessionStorage.getItem("waifu-text") > i)
            return;
        t && (clearTimeout(t),
        t = null),
        o = e(o),
    ...
    class s {
        ...
        async loadModel(e, t, s) {
            if (localStorage.setItem("modelId", e),
        ...
        async loadRandModel() {
            ...
            if (this.useCDN) {
                ...
                localStorage.setItem("modelTexturesId", t),
                this.modelList.models[e].length && loadlive2d("live2d", `${this.cdnPath}model/${s}/index.json`),
                o("我的新衣服好看嘛？", 4e3, 10)
            } else
                fetch(`${this.apiPath}rand_textures/?id=${e}-${t}`).then((e=>e.json())).then((s=>{
                    1 !== s.textures.id || 1 !== t && 0 !== t ? this.loadModel(e, s.textures.id, "我的新衣服好看嘛？") : o("我还没有其他衣服呢！", 4e3, 10)
                }
                ))
        }
    ...
    const i = {
        hitokoto: {
            ...
            callback: function() {
                fetch("https://international.v1.hitokoto.cn/?c=k&c=i").then((e=>e.json())).then((e=>{
    ...
    function n(t) {
        const n = new s(t);
        function c(t) {
            let s, i, n = !1, c = t.message.default;
            ...
            o(function(e) {
                ...
                if ("" !== document.referrer) {
                    ...
                    return location.hostname === e.hostname ? t : (o = s in i ? i[s] : e.hostname,
            ...
            t.seasons.forEach((({date: t, text: o})=>{
                const s = new Date
                  , i = t.split("-")[0]
                  , n = t.split("-")[1] || i;
                i.split("/")[0] <= s.getMonth() + 1 && s.getMonth() + 1 <= n.split("/")[0] && i.split("/")[1] <= s.getDate() && s.getDate() <= n.split("/")[1] && (o = (o = e(o)).replace("{year}", s.getFullYear()),
                c.push(o))
            }
            ));
            const a = ()=>{}
