!function (t) {
    ...
    [function (t, i, e) {
      ...
      r.prototype.loadExpression = function (t, i, e) {
        var r = c.getPlatformManager();
        this.debugMode &&
        r.log('Load Expression : ' + i);
        var n = this;
        r.loadBytes(
          i,
          function (i) {
            null != t &&
            (n.expressions[t] = o.loadJson(i)),
            'function' == typeof e &&
            e()
          }
        )
      ...
      o.loadJson = function (t) {
        ...
        if (
          i.setFadeIn(parseInt(r.fade_in) > 0 ? parseInt(r.fade_in) : 1000),
          i.setFadeOut(parseInt(r.fade_out) > 0 ? parseInt(r.fade_out) : 1000),
          null == r.params
        ) return i;
        var s = r.params,
        _ = s.length;
      ...
      o.prototype.updateParamExe = function (t, i, e, r) {
        for (var n = this.paramList.length - 1; n >= 0; --n) {
          ...
          s.type == o.TYPE_ADD ? t.addToParamFloat(s.id, s.value, e) : s.type == o.TYPE_MULT ? t.multParamFloat(s.id, s.value, e) : s.type == o.TYPE_SET &&
      ...
      $.prototype.updateParam = function (t) {
        if (null != t) {
          ...
          e = 0 == this.lastTime ? 0 : (i - this.lastTime) / 1000;
          this.lastTime = i,
          e < 0 &&
          (e = 0);
      ...
      p.prototype.update = function () {
        ...
        var i = UtSystem.getUserTimeMSec(),
        e = (i - this.lastTimeSec) * p.FRAME_RATE / 1000;
        this.lastTimeSec = i;
        ...
        if (!(Math.abs(n) <= this.EPSILON && Math.abs(s) <= this.EPSILON)) {
          ...
          c > f &&
          (this.faceVX *= f / c, this.faceVY *= f / c),
      ...
      f.prototype.adjustScale = function (t, i, e) {
        var r = e * this.tr[0];
        r < this.min ? this.tr[0] > 0 &&
        (e = this.min / this.tr[0]) : r > this.max &&
        this.tr[0] > 0 &&
    ...
    function (t, i, e) {
        ...
        (
          ...
          function t() {
            ...
            if (window.Live2D.captureFrame) {
              ...
              e.href = C.toDataURL(),
              e.download = window.Live2D.captureName ||
              'live2d.png',
              e.click()
            }
            i(t, C)
      ...
      function u(t) {
        ...
        console.log(
          'onMouseMove device( x:' + t.clientX + ' y:' + t.clientY + ' ) view( x:' + n + ' y:' + s + ')'
        ),
        k = e,
        V = r,
        N.setPoint(n, s)
      ...
      function p(t) {
        ...
        w.default.DEBUG_MOUSE_LOG &&
        console.log(
          'onMouseDown device( x:' + t.clientX + ' y:' + t.clientY + ' ) view( x:' + n + ' y:' + s + ')'
        ),
        k = e,
        V = r,
        R.tapEvent(n, s)
      ...
      function y(t) {
        ...
        u(i) : 'touchmove' == t.type ? f(i) : 'touchend' == t.type &&
        c()
      }
      function m(t) {
      ...
      (
        function (t) {
          !function () {
            ...
            function I() {
              At ||
              (this._$kP = null, this._$dr = null, this._$Ai = !0, this._$mS = null)
            }
            function w() {
            }
            function x() {
            ...
            function j() {
              At ||
              (this._$NL = null, this._$3S = null, this._$aS = null, j._$42++)
            }
            function q() {
              At ||
              (i.prototype.constructor.call(this), this._$zo = new X)
            }
            function J() {
              At ||
              (
            ...
            function ct() {
              At ||
              (this.motions = null, this._$eb = !1, this.motions = new Array)
            }
            function dt() {
              this._$w0 = null,
              this._$AT = !0,
            ...
            i.prototype.getIndexArray = function (t) {
              ...
              return null != i &&
              i.getType() == W._$wb &&
              i instanceof $t ? i.getIndexArray() : null
            },
            e.CHANNEL_COUNT = 4,
            ...
            _._$nr = function (t, i, e) {
              console.log('%s\n', t);
              for (var r = i.length, o = 0; o < r; ++o) console.log('%5d', i[o]),
              console.log('%s\n', e),
              console.log(',');
              console.log('\n')
            },
            ...
            v._$br = function (t, i, e, r) {
              ...
              if (4 == o) {
                ...
                B = s[3];
                return (1 - B) * (
                  (1 - P) * ((1 - u) * (S + (v - S) * h) + u * (L + (M - L) * h)) + P * ((1 - u) * (E + (A - E) * h) + u * (I + (w - I) * h))
                ) + B * (
                  (1 - P) * ((1 - u) * (x + (O - x) * h) + u * (D + (R - D) * h)) + P * ((1 - u) * (b + (F - b) * h) + u * (C + (N - C) * h))
                )
              }
            ...
            v._$Vr = function (t, i, e, r, o, n, s, _) {
              ...
              u += _;
                ...
                for (var Et = 1 << a, At = new Float32Array(Et), It = 0; It < Et; It++) {
                  for (var wt = It, xt = 1, Ot = 0; Ot < a; Ot++) xt *= wt % 2 == 0 ? 1 - l[Ot] : l[Ot],
                  wt /= 2;
                  At[It] = xt
                }
                for (var Dt = new Float32Array(Et), Rt = 0; Rt < Et; Rt++) Dt[Rt] = o[h[Rt]];
                for (var c = 0; c < $; ) {
                  for (var bt = 0, Ft = 0, Ct = c + 1, Rt = 0; Rt < Et; Rt++) bt += At[Rt] * Dt[Rt][c],
                  Ft += At[Rt] * Dt[Rt][Ct];
                  c += 2,
                  n[u] = bt,
                  n[u + 1] = Ft,
            ...
            R.prototype.mult = function (t, i, e) {
              return null == i ? null : (
                this == i ? this.mult_safe(this.m, t.m, i.m, e) : this.mult_fast(this.m, t.m, i.m, e),
                i
              )
            },
            ...
            F.prototype.update = function () {
              0 == this._$H &&
              0 == this._$f ? 1 == this._$7 &&
              1 == this._$g ? 0 == this._$k &&
              0 == this._$w ? (this._$hi = F.STATE_IDENTITY, this._$Z = F._$pS) : (this._$hi = F._$gb, this._$Z = F._$hb) : 0 == this._$k &&
              0 == this._$w ? (this._$hi = F._$fo, this._$Z = F._$kS) : (this._$hi = F._$fo | F._$gb, this._$Z = F._$kS) : 0 == this._$7 &&
              0 == this._$g ? 0 == this._$k &&
              0 == this._$w ? (this._$hi = F._$go, this._$Z = F._$kS) : (this._$hi = F._$go | F._$gb, this._$Z = F._$kS) : 0 == this._$k &&
              0 == this._$w ? (this._$hi = F._$go | F._$fo, this._$Z = F._$kS) : (this._$hi = F._$go | F._$fo | F._$gb, this._$Z = F._$kS)
            },
            F.prototype._$RT = function (t) {
              ...
              s = i * o - e * r;
              0 == n ? at._$so &&
              console.log('affine._$RT() / rt==0') : (t[0] = n, t[1] = s / n, t[2] = (r * o + i * e) / s, t[3] = Math.atan2(r, i))
            },
            ...
            C.loadMotion = function (t) {
                  ...
                  if ('a' <= n && n <= 'z' || 'A' <= n && n <= 'Z' || '_' == n) {
                    ...
                    if (_ >= 0) {
                      ...
                      O.startsWith(t, s, C._$cs) ? (a._$RP = B._$hs, a._$4P = new String(t, s, _ - s)) : O.startsWith(t, s, C._$ar) ? (
                        ...
                        O.startsWith(t, s + 7, 'ANCHOR_X') ? a._$RP = B._$xs : O.startsWith(t, s + 7, 'ANCHOR_Y') ? a._$RP = B._$us : O.startsWith(t, s + 7, 'SCALE_X') ? a._$RP = B._$qs : O.startsWith(t, s + 7, 'SCALE_Y') ? a._$RP = B._$Ys : O.startsWith(t, s + 7, 'X') ? a._$RP = B._$ws : O.startsWith(t, s + 7, 'Y') &&
                        (a._$RP = B._$Ns)
              ...
              return i._$AS = 1000 * i._$yT / i._$D0 | 0,
              i
            },
            ...
            k._$C = function (t) {
              ...
              try {
                ...
                e = new _$js;
                for (var r, o = new Int8Array(1000); (r = i.read(o)) > 0; ) e.write(o, 0, r);
                return e._$TS()
              } finally {
                null != t &&
                t.close(),
            ...
            V.prototype._$7T = function (t) {
              ...
              switch (this._$_L) {
                ...
                case STATE_CLOSED:
                  ...
                  r >= 1 &&
                  (this._$_L = wt.STATE_OPENING, this._$bb = e),
                  i = 0;
                  break;
                case STATE_OPENING:
                  r = (e - this._$bb) / this._$mr,
                  r >= 1 &&
                  (r = 1, this._$_L = wt.STATE_INTERVAL, this._$12 = this._$T2()),
                  i = r;
                  break;
                case STATE_INTERVAL:
                  this._$12 < e &&
            ...
            X._$cr = function (t, i) {
              return null == t ||
              t._$yL() < i.length ? (t = X._$9r(2 * i.length), t.put(i), t._$oT(0)) : (t.clear(), t.put(i), t._$oT(0)),
              t
            },
            X._$mb = function (t, i) {
              return null == t ||
              t._$yL() < i.length ? (t = X._$vb(2 * i.length), t.put(i), t._$oT(0)) : (t.clear(), t.put(i), t._$oT(0)),
              t
            },
            X._$Hs = function () {
              return X._$Gr
            ...
            J.loadMotion = function (t) {
              ...
              for (var o = 0; o < r; ++o) {
                ...
                if ('\n' != n && '\r' != n) if ('#' != n) if ('$' != n) {
                  if (97 <= s && s <= 122 || 65 <= s && s <= 90 || '_' == n) {
                    ...
                    if (a >= 0) {
                      var h = new B;
                      O.startsWith(t, _, J._$cs) ? (h._$RP = B._$hs, h._$4P = O.createString(t, _, a - _)) : O.startsWith(t, _, J._$ar) ? (
                        h._$4P = O.createString(t, _ + 7, a - _ - 7),
                        O.startsWith(t, _ + 7, 'ANCHOR_X') ? h._$RP = B._$xs : O.startsWith(t, _ + 7, 'ANCHOR_Y') ? h._$RP = B._$us : O.startsWith(t, _ + 7, 'SCALE_X') ? h._$RP = B._$qs : O.startsWith(t, _ + 7, 'SCALE_Y') ? h._$RP = B._$Ys : O.startsWith(t, _ + 7, 'X') ? h._$RP = B._$ws : O.startsWith(t, _ + 7, 'Y') &&
                        (h._$RP = B._$Ns)
              ...
              return i._$rr = 1000 * i._$yT / i._$D0 | 0,
              i
            },
            ...
            nt.expandClip = function (t, i, e, r, o, n, s, _, a, h) {
              ...
              (nt.clipWithTransform(t, N, M, E, A, I, w, x, O, D, F, C, R, b), !0)
            },
              ...
              try {
                ...
                if (!e && (W.prototype._$2b.call(this, t), this._$32())) {
                  ...
                  _._$li('_$L _$0P _$G :: %s', o);
                    ...
                    s = t._$q2(r._$8r);
                    null == n ||
                    s._$x2() ? r._$AT = !1 : (n._$nb(t, s, r._$Cr, r._$hr, this._$d0, U._$i2, U._$No), r._$AT = !0),
            ...
            ct.prototype.startMotion = function (t, i) {
              for (var e = null, r = this.motions.length, o = 0; o < r; ++o) null != (e = this.motions[o]) &&
              (
            ...
            mt._$cr = function (t, i) {
              return null == t ||
              t._$yL() < i.length ? (t = mt._$9r(2 * i.length), t.put(i), t._$oT(0)) : (t.clear(), t.put(i), t._$oT(0)),
              t
            },
            mt._$mb = function (t, i) {
              return null == t ||
              t._$yL() < i.length ? (t = mt._$vb(2 * i.length), t.put(i), t._$oT(0)) : (t.clear(), t.put(i), t._$oT(0)),
              t
            },
            mt._$Hs = function () {
              return this._$Gr
            ...
            mt.prototype._$ZT = function () {
              ...
              (
                this.initShader(),
                this.firstDraw = !1,
                this.anisotropyExt = t.getExtension('EXT_texture_filter_anisotropic') ||
            ...
            Et.getOS = function () {
              ...
              Et.setup(),
              Et.SYSTEM_INFO._isIPhone ||
              Et.SYSTEM_INFO._isIPad ? 'iOS' : Et.SYSTEM_INFO._isAndroid ? 'Android' : '_$Q0 OS'
            },
            Et.setup = function () {
              function t(t, i) {
                for (
    ...
    function (t, i, e) {
                    ...
                    function () {
                      if (r.isTexLoaded) {
                        ...
                        if (
                          ...
                          null != r.modelSetting.getPoseFile() ? r.loadPose(
                          ...
                          null != n.center_x &&
                          r.modelMatrix.centerX(n.center_x),
                          null != n.center_y &&
                          r.modelMatrix.centerY(n.center_y),
                          null != n.top &&
      ...
      o.prototype.startMotion = function (t, i, e) {
        ...
        var o,
        n = this;
        null == this.motions[t] ? this.loadMotion(
          null,
          this.modelHomeDir + r,
          function (r) {
            o = r,
    ...
    function (t, i, e) {
      ...
      r.prototype.loadModelSetting = function (t, i) {
        var e = this;
        o.Live2DFramework.getPlatformManager().loadBytes(
          t,
          function (t) {
      ...
      r.prototype.getTextureFile = function (t) {
        ...
        null == this.json[this.TEXTURES][t] ? null : this.json[this.TEXTURES][t]
      },
      ...
      r.prototype.getHitAreaID = function (t) {
        ...
        null == this.json[this.HIT_AREAS][t] ? null : this.json[this.HIT_AREAS][t][this.ID]
      },
      r.prototype.getHitAreaName = function (t) {
        return null == this.json[this.HIT_AREAS] ||
        null == this.json[this.HIT_AREAS][t] ? null : this.json[this.HIT_AREAS][t][this.NAME]
      },
      ...
      r.prototype.getMotionNum = function (t) {
        ...
        null == this.json[this.MOTION_GROUPS][t] ? 0 : this.json[this.MOTION_GROUPS][t].length
      },
      r.prototype.getMotionFile = function (t, i) {
        return null == this.json[this.MOTION_GROUPS] ||
        null == this.json[this.MOTION_GROUPS][t] ||
        null == this.json[this.MOTION_GROUPS][t][i] ? null : this.json[this.MOTION_GROUPS][t][i][this.FILE]
      },
      r.prototype.getMotionSound = function (t, i) {
        return null == this.json[this.MOTION_GROUPS] ||
        null == this.json[this.MOTION_GROUPS][t] ||
        null == this.json[this.MOTION_GROUPS][t][i] ||
        null == this.json[this.MOTION_GROUPS][t][i][this.SOUND] ? null : this.json[this.MOTION_GROUPS][t][i][this.SOUND]
      },
      r.prototype.getMotionFadeIn = function (t, i) {
        return null == this.json[this.MOTION_GROUPS] ||
        null == this.json[this.MOTION_GROUPS][t] ||
        null == this.json[this.MOTION_GROUPS][t][i] ||
        null == this.json[this.MOTION_GROUPS][t][i][this.FADE_IN] ? 1000 : this.json[this.MOTION_GROUPS][t][i][this.FADE_IN]
      },
      r.prototype.getMotionFadeOut = function (t, i) {
        return null == this.json[this.MOTION_GROUPS] ||
        null == this.json[this.MOTION_GROUPS][t] ||
        null == this.json[this.MOTION_GROUPS][t][i] ||
        null == this.json[this.MOTION_GROUPS][t][i][this.FADE_OUT] ? 1000 : this.json[this.MOTION_GROUPS][t][i][this.FADE_OUT]
      },
      r.prototype.getInitParamID = function (t) {
        return null == this.json[this.INIT_PARAM] ||
        null == this.json[this.INIT_PARAM][t] ? null : this.json[this.INIT_PARAM][t][this.ID]
      },
      r.prototype.getInitParamValue = function (t) {
        return null == this.json[this.INIT_PARAM] ||
        null == this.json[this.INIT_PARAM][t] ? NaN : this.json[this.INIT_PARAM][t][this.VALUE]
      },
      ...
      r.prototype.getInitPartsVisibleID = function (t) {
        ...
        null == this.json[this.INIT_PARTS_VISIBLE][t] ? null : this.json[this.INIT_PARTS_VISIBLE][t][this.ID]
      },
      r.prototype.getInitPartsVisibleValue = function (t) {
        return null == this.json[this.INIT_PARTS_VISIBLE] ||
        null == this.json[this.INIT_PARTS_VISIBLE][t] ? NaN : this.json[this.INIT_PARTS_VISIBLE][t][this.VALUE]
      }
    }
    ]
  );
